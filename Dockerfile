...
#CMD echo "coucou" && echo lol
CMD make recalbox-${ARCH}_defconfig && sed -i "s|BR2_DL_DIR=.*|BR2_DL_DIR=\"/work/dl\"|g" .config && sed -i "s|BR2_HOST_DIR=.*\"|BR2_HOST_DIR=\"/work/hosts/host-${ARCH}\"|g" .config && make
